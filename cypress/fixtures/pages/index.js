...
const Index = ({ shows }) => (
  <div>
    ...
    <ul>
      ...
      <li>
        <Link
          ...
          as="/getStaticProps/withFallback/3"
        >
      ...
      <li>
        <Link
          href="/getStaticProps/withFallback/[id]"
          as="/getStaticProps/withFallback/4"
        >
      ...
      <li>
        <Link
          href="/getStaticProps/withFallback/[id]"
          as="/getStaticProps/withFallback/75"
        >
          <a>
      ...
      <li>
        <Link
          href="/getStaticProps/withFallback/[...slug]"
          as="/getStaticProps/withFallback/my/path/2"
        >
      ...
      <li>
        <Link
          href="/getStaticProps/withFallback/[...slug]"
          as="/getStaticProps/withFallback/my/undefined/path/75"
        >
          <a>
            getStaticProps/withFallback/my/undefined/path/75 (catch-all route,
            not pre-rendered)
          </a>
        </Link>
      </li>
    ...
    <ul>
      ...
      <li>
        <Link
          href="/getServerSideProps/catch/all/[...slug]"
          as="/getServerSideProps/catch/all/1337"
        >
      ...
      <li>
        <Link
          href="/getServerSideProps/catch/all/[...slug]"
          as="/getServerSideProps/catch/all/1338"
        >
