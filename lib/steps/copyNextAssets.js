...
const copyNextAssets = (publishPath) => {
  ...
  if (!existsSync(staticAssetsPath)) {
    throw "No static assets found in .next dist (aka no /.next/static). Please check your project configuration. Your next.config.js must be one of `serverless` or `experimental-serverless-trace`. Your build command should include `next build`.";
  }
